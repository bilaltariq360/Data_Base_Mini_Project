...
StudentNode::StudentNode(string firstName, string lastName, int id, string userName, string email, Date registrationDate, string gender, string contactNo, string bloodGroup, string address, bool feeStatus) {
